...
describe "Completing todo items" do
	...
	it "should be successful when marking a single item complete" do
	...
	context "with completed items" do
		...
		it "should show completed items as complete" do
			visit_todo_list todo_list
		...
		it "should not giveb the option to mark complete" do
			visit_todo_list todo_list
			within dom_id_for(completed_todo_item) do
